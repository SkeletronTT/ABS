...
- Версия 0.1.0  
    ...
    Эту версию можно (и нужно) считать сырой преальфой. Настраивать координаты города надо внутри ABS.py и env файл создавать вручную, в котором указывается API-ключ.  
    ```
